 ...
 * 
 * Modified for VSBloom: Changed 'this.PIXI' to 'window.PIXI' to work
 * correctly when bundled by esbuild.
 */
...
var unsafe_eval_js = (function (exports) {
    ...
    // VSBloom: Don't auto-call selfInstall() - we need to call it manually
    // AFTER window.PIXI is properly set up with the real PixiJS classes
    // selfInstall();
    ...
    // VSBloom: Export selfInstall so it can be called manually
...
Object.assign(window.PIXI, unsafe_eval_js);
