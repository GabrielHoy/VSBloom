...
function OnWindowBlurred(_event: Event) {
...
export async function Start(configResolver: EffectConfigResolver) {
	...
	janitor.Add(() => bloom.configs.UnregisterEffectConfigMutator(longTermUnfocusThresholdMutator));
	...
	const shortTermUnfocusEffectFilterMutator = await bloom.configs.RegisterEffectConfigMutator({
		...
		internalValueMutator: (changedValue) => {
			...
			document.documentElement.style.setProperty(
				...
				effectConfig.shortTermUnfocusEffectFilter,
			);
		},
	});
	janitor.Add(() =>
		bloom.configs.UnregisterEffectConfigMutator(shortTermUnfocusEffectFilterMutator),
	);
	const longTermUnfocusEffectFilterMutator = await bloom.configs.RegisterEffectConfigMutator({
		...
		internalValueMutator: (changedValue) => {
			...
			document.documentElement.style.setProperty(
				...
				effectConfig.longTermUnfocusEffectFilter,
			);
		},
	});
	janitor.Add(() =>
		bloom.configs.UnregisterEffectConfigMutator(longTermUnfocusEffectFilterMutator),
	);

	/* Effect Transition Duration Mutators */
	const shortTermUnfocusEffectTransitionDurationMutator =
		await bloom.configs.RegisterEffectConfigMutator({
			pathResolver: configResolver.GetPropertyPath(
			...
			internalValueMutator: (changedValue) => {
				...
				document.documentElement.style.setProperty(
					...
					`${effectConfig.shortTermUnfocusEffectTransitionDuration}s`,
				);
			},
		});
	janitor.Add(() =>
		bloom.configs.UnregisterEffectConfigMutator(
			shortTermUnfocusEffectTransitionDurationMutator,
		),
	);
	const longTermUnfocusEffectTransitionDurationMutator =
		await bloom.configs.RegisterEffectConfigMutator({
			...
			internalValueMutator: (changedValue) => {
				...
				document.documentElement.style.setProperty(
					...
					`${effectConfig.longTermUnfocusEffectTransitionDuration}s`,
				);
			},
		});
	janitor.Add(() =>
		bloom.configs.UnregisterEffectConfigMutator(longTermUnfocusEffectTransitionDurationMutator),
	);

	/* Window Refocus Effect Transition Duration Mutator */
	const windowRefocusEffectTransitionDurationMutator =
		await bloom.configs.RegisterEffectConfigMutator({
			...
			internalValueMutator: (changedValue) => {
				...
				document.documentElement.style.setProperty(
					...
					`${effectConfig.windowRefocusEffectTransitionDuration}s`,
				);
			},
		});
	janitor.Add(() =>
		bloom.configs.UnregisterEffectConfigMutator(windowRefocusEffectTransitionDurationMutator),
	);
}
