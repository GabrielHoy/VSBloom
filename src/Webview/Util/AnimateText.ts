                    ...
                    if (useTextMorphing) {
                        ...
                        if (useTwoPhaseAnimation) {
                            ...
                            if (progress <= lengthPhaseEnd) {
                                ...
                                const currentTargetLength = Math.round(startLength + (endLength - startLength) * lengthProgress);
                                ...
                                const revealProgress = (progress - lengthPhaseEnd) / (1 - lengthPhaseEnd);
                            ...
                            const currentTargetLength = Math.round(startLength + (endLength - startLength) * progress);
