...
const pageList: SvelteMap<PageDescriptor['name'], PageDescriptor> = $state(
	new SvelteMap([
		[
			'Getting Started',
			{
		...
		[
			'Extension Settings',
			{
				...
				description:
					'Configure various aspects of the VS: Bloom extension and the configurations it provides.',
				notFinished: false,
				component: Settings,
			},
		],
