...
var r = { grad: 0.9, turn: 360, rad: 360 / (2 * Math.PI) },
	t = (r) => ('string' == typeof r ? r.length > 0 : 'number' == typeof r),
	n = (r, t, n) => (
		void 0 === t && (t = 0), void 0 === n && (n = 10 ** t), Math.round(n * r) / n + 0
	),
	e = (r, t, n) => (void 0 === t && (t = 0), void 0 === n && (n = 1), r > n ? n : r > t ? r : t),
	u = (r) => ((r = isFinite(r) ? r % 360 : 0) > 0 ? r : r + 360),
	o = (r) => ({ r: e(r.r, 0, 255), g: e(r.g, 0, 255), b: e(r.b, 0, 255), a: e(r.a) }),
	a = (r) => ({ r: n(r.r), g: n(r.g), b: n(r.b), a: n(r.a, 3) }),
	s = /^#([0-9a-f]{3,8})$/i,
	i = (r) => {
		var t = r.toString(16);
	...
	d = (r) => ({ h: u(r.h), s: e(r.s, 0, 100), l: e(r.l, 0, 100), a: e(r.a) }),
	g = (r) => ({ h: n(r.h), s: n(r.s), l: n(r.l), a: n(r.a, 3) }),
	f = (r) =>
		b(
			((n = (t = r).s),
			{
	...
	I = (r) => (299 * r.r + 587 * r.g + 114 * r.b) / 1e3 / 255,
	H = (r, t) => {
		var n = p(r);
...
(exports.Colord = $),
	...
	(exports.getFormat = (r) => x(r)[1]),
	(exports.random = () =>
		new $({ r: 255 * Math.random(), g: 255 * Math.random(), b: 255 * Math.random() }));
