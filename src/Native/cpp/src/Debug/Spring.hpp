/**
 * Damped spring for semi-pretty value smoothing when needed, since it's going to be
 * much faster to update 1,024 springs etc. here in "C++ land" than it would be in TS/JS.
 */
#pragma once
